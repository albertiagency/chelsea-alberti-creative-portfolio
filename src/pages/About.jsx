...
const ABOUT_PORTRAIT = 'https://media.base44.com/images/public/6a3416a0b2d81e218daa4cbb/cb933fabd_20250914_Chelsea_Studio_9.jpg';
      ...
      <section className="py-20 lg:py-28 bg-secondary/40">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-1.5">
              {roles.map((role) => (
