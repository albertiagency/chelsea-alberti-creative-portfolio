      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              to="/contact"
              className="ml-2 px-5 py-2 text-sm font-body font-medium rounded-sm transition-all duration-300 bg-primary text-primary-foreground hover:bg-accent hover:text-accent-foreground"
            >
              Get in touch
            </Link>
          </div>
